...
public class HudViewController implements OnTouchListener, OnGestureListener {
	...
	public enum JoystickType {
		NONE, ANALOGUE, ACCELERO, COMBINED, MAGNETO
	}
	...
	public HudViewController(Activity context, boolean useSoftwareRendering) {
		...
		btnEmergency = new Button(res, R.drawable.btn_emergency_normal, R.drawable.btn_emergency_pressed,
				Align.TOP_CENTER);
		...
		btnRecord = new ToggleButton(res, R.drawable.btn_record, R.drawable.btn_record_pressed, R.drawable.btn_record1,
				R.drawable.btn_record1_pressed, R.drawable.btn_record2, Align.TOP_RIGHT);
		...
		int batteryIndicatorRes[] = { R.drawable.btn_battery_0, R.drawable.btn_battery_1, R.drawable.btn_battery_2,
		...
		int wifiIndicatorRes[] = { R.drawable.btn_wifi_0, R.drawable.btn_wifi_1, R.drawable.btn_wifi_2,
